...
const tier3: LanguageEntry[] = [
  ...
  { name: 'Mojo', extensions: ['.mojo'], tier: 3, skipDirs: [], entryPoints: [], packageFiles: [] },
  { name: 'Roc', extensions: ['.roc'], tier: 3, skipDirs: [], entryPoints: [], packageFiles: [] },
  { name: 'Odin', extensions: ['.odin'], tier: 3, skipDirs: [], entryPoints: [], packageFiles: [] },
  { name: 'Vale', extensions: ['.vale'], tier: 3, skipDirs: [], entryPoints: [], packageFiles: [] },
  { name: 'Bend', extensions: ['.bend'], tier: 3, skipDirs: [], entryPoints: [], packageFiles: [] },
  { name: 'Unison', extensions: ['.u'], tier: 3, skipDirs: [], entryPoints: [], packageFiles: [] },
  { name: 'YAML', extensions: ['.yaml', '.yml'], tier: 3, skipDirs: [], entryPoints: [], packageFiles: [] },
  { name: 'TOML', extensions: ['.toml'], tier: 3, skipDirs: [], entryPoints: [], packageFiles: [] },
  { name: 'JSON', extensions: ['.json', '.jsonc'], tier: 3, skipDirs: [], entryPoints: [], packageFiles: [] },
  { name: 'Nix', extensions: ['.nix'], tier: 3, skipDirs: [], entryPoints: [], packageFiles: [] },
  { name: 'Dhall', extensions: ['.dhall'], tier: 3, skipDirs: [], entryPoints: [], packageFiles: [] },
  { name: 'CUE', extensions: ['.cue'], tier: 3, skipDirs: [], entryPoints: [], packageFiles: [] },
  { name: 'Jsonnet', extensions: ['.jsonnet', '.libsonnet'], tier: 3, skipDirs: [], entryPoints: [], packageFiles: [] },
  { name: 'Svelte', extensions: ['.svelte'], tier: 3, skipDirs: [], entryPoints: [], packageFiles: [] },
  { name: 'Vue', extensions: ['.vue'], tier: 3, skipDirs: [], entryPoints: [], packageFiles: [] },
  { name: 'Astro', extensions: ['.astro'], tier: 3, skipDirs: [], entryPoints: [], packageFiles: [] },
  { name: 'MDX', extensions: ['.mdx'], tier: 3, skipDirs: [], entryPoints: [], packageFiles: [] },
  { name: 'Fish', extensions: ['.fish'], tier: 3, skipDirs: [], entryPoints: [], packageFiles: [] },
  { name: 'Nushell', extensions: ['.nu'], tier: 3, skipDirs: [], entryPoints: [], packageFiles: [] },
  { name: 'Jupyter', extensions: ['.ipynb'], tier: 3, skipDirs: [], entryPoints: [], packageFiles: [] },
];
